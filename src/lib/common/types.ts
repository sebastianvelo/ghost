export type Declaration = [string, string] | [string, string, "important"];

export const PropertySeparator = `_`;
export type PropertySeparatorType = typeof PropertySeparator;
