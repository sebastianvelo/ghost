...
export const TextBodyExample = (classNames: string[], tag: string = "p", overrideColor = true) => GenericBodyExample({
    classNames,
    tag,
...
export const TextOverflowBodyExample = (classNames: string[], tag: string = "p", overrideColor = true) => GenericBodyExample({
    classNames,
    tag,
